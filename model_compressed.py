...
class VAE_Classifier(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = 100 * recon_loss + self.alpha_y * class_loss # - self.beta * kl_div 
...
class VAE(nn.Module):
    ...
    def forward(self, x):
        ...
        y_predicted = self.classifier(z)

        return reconstruction, y_predicted, None, None #, z_q, qz
...
class Encoder(nn.Module):
    def __init__(self, latent_dim) -> None:
        super().__init__()
        # n x 1 x 128 x 128
        self.c1 = ConvBlock(1, 16, 3, 1, 1)
        # n x 16 x 64 x 64
        self.c2 = ConvBlock(16, 32, 3, 1, 1)
        # n x 32 x 32 x 32
        self.c3 = ConvBlock(32, 64, 3, 1, 1)
        # n x 64 x 16 x 16
